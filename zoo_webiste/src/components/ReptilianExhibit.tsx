...
const ReptilianExhibit = ({
  ...
  return (
    <section className="puff-in-bottom">
      <div className="flex justify-end items-center w-full p-5 bg-green-700">
        <button
      ...
      <div
        id="reptilian"
        className="flex lg:flex-row flex-col justify-center items-center gap-[5rem] relative w-full lg:h-[60rem] h-[75rem] lg:px-10 md:px-5 px-3 bg-green-700 z-10"
      >
        <img
